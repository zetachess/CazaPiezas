...
<iframe
  ...
  src="https://TU_USUARIO.github.io/TU_REPO/goblinsnake/?v=12"
...
```html
<iframe style="max-width:100%" src="https://TU_USUARIO.github.io/TU_REPO/goblinsnake/?v=12" width="500" height="620" frameborder="0" allow="autoplay; gamepad" allowfullscreen></iframe>
```
